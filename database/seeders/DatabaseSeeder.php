...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Materi::create([
            ...
            'judul' => "Mad Thabi'ie",
            'slug' => "mad-thabi'ie",
            'desc' => "Apabila ada: Alif [ا], sesudah fathah [ َ ], atau yaa' sukun [ى], sesudah kasrah [ ِ ], atau wau  [و], sesudah dhammah  [ ُ ], maka hukum bacaannya disebut: Mad Thabi'ie    [مد طبيعى].",
            'body' => "<div>Apabila ada:<br>Alif&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;[<strong>ا</strong>], sesudah fathah&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;[<strong> َ </strong>], atau<br>yaa' sukun&nbsp; [<strong>ى</strong>], sesudah kasrah&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;[<strong> ِ </strong>], atau <br>wau&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;[<strong>و</strong>], sesudah dhammah&nbsp; [<strong> ُ</strong> ],<br>maka hukum bacaannya disebut:</div><blockquote>Mad Thabi'ie&nbsp; &nbsp; [مد طبيعى]</blockquote><div>Mad artinya&nbsp; &nbsp; &nbsp; &nbsp; :panjang<br>Thabi'ie artinya&nbsp; : biasa<br><br>Cara membacanya: harus panjang sepanjang dua harakat (dua gerakan huruf), atau disebut satu alif&nbsp;<br>Misalnya :<br>قو لوا . فيه . مال . نوحيها<br>dan sebagainya.</div>",
        ]);
        // 17
        Materi::create([
            'category_id' => 9,
